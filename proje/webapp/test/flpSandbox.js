		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sertifakalifirmalarproje-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sertifakalifirmalarproje-display": {
								"semanticObject": "sertifakalifirmalarproje",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sertifakalifirmalar.proje",
									"url": sap.ui.require.toUrl("sertifakalifirmalar/proje")
								}
							}
						}
					}
